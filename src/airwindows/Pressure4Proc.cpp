...
void Pressure4::processReplacing(float** inputs, float** outputs,
                                 int sampleFrames) {
  ...
  while (--sampleFrames >= 0) {
    ...
    // second stage of overdrive to prevent overs and allow bloody loud
    // extremeness
...
void Pressure4::processDoubleReplacing(double** inputs, double** outputs,
                                       int sampleFrames) {

...
void Interstage::processReplacing(float** inputs, float** outputs, int sampleFrames)
{
    float* in1 = inputs[0];
    float* in2 = inputs[1];
    ...
    while (--sampleFrames >= 0)
    {
        ...
        // start the lowpassing with an average
...
void Interstage::processDoubleReplacing(double** inputs, double** outputs, int sampleFrames)
{
    double* in1 = inputs[0];
    double* in2 = inputs[1];

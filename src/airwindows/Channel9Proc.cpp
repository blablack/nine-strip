...
void Channel9::processReplacing(float** inputs, float** outputs,
                                int sampleFrames) {
  float* in1 = inputs[0];
  float* in2 = inputs[1];
  ...
  while (--sampleFrames >= 0) {
    ...
    double distSampleL = sin(inputSampleL * fabs(inputSampleL)) /
    ...
    double distSampleR = sin(inputSampleR * fabs(inputSampleR)) /
    ...
    lastSampleAL = (lastSampleAL * 0.381966011250105) +
                   (inputSampleL *
                    0.6180339887498948482045);  // split the difference between
...
void Channel9::processDoubleReplacing(double** inputs, double** outputs,
                                      int sampleFrames) {
  double* in1 = inputs[0];
  double* in2 = inputs[1];
